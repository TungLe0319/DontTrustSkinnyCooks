  ...
  <div v-auto-animate class="">
    <div v-if="showBanner" class=" relative p-5 rounded border border-black/20 dark:bg-gray-900">
      ...
      <div class="relative mt-5">
        <div class="relative z-10" :class="homePage ? '' : 'mb-4'">
          <div class="w-8/12">
            ...
            <UButton
              :size="homePage ? 'xl' : 'sm'" class="bg-primary my-5  hover:bg-primary/70 transition-all duration-150 hover:scale-[1.01]"
              :class="homePage ? 'text-3xl' : 'text-xl'"
              @click="signIn"
            >
              Sign Up!
            </UButton>
        ...
        >
          ...
          >
            <g>
              <path
                id="uuid-25964adc-e6e4-4b9a-b8ec-929b0c1831fb-276"
            ...
            <g>
              <path
                id="uuid-a5d71dbf-4b88-4e86-8463-d776047f9b39-277"
            ...
            />
            <g>
              <circle cx="167.85481" cy="121.92467" r="57.8752" fill="#ffb6b6" />
              <path
            ...
            <path
              ...
              fill="#3f3d56"
            />
            <rect x="88.07767" y="189.41347" width="31.70614" height="117.17485" fill="#3f3d56" />
            <rect x="185.95312" y="215.6055" width="31.70615" height="96.49695" fill="#3f3d56" />
            <path
            ...
            <path
              ...
              fill="#3f3d56"
            />
            <rect x="573.31946" y="200.44168" width="31.70612" height="117.17484" fill="#3f3d56" />
            <rect x="475.44397" y="226.63376" width="31.70615" height="96.49692" fill="#3f3d56" />
            <circle cx="526.48047" cy="115.35628" r="72.48663" fill="#a0616a" />
            <path
            ...
            <g>
              <path
                id="uuid-cca3ea91-4b8f-4d88-9418-fea0098b5ff4-278"
            ...
            />
            <path
              id="uuid-f7f7485f-a1d4-48b6-9f93-907c0610bac7-279"
      ...
      <div class="absolute top-4 right-4">
        <Icon name="heroicons:x-mark-20-solid" class="text-5xl hover:cursor-pointer" @click="handleAlertClose" />
      </div>
    </div>
  </div>
</template>
